...
- Added a new performance test file

### Changed

- Updated the script to include improved schema validation
- Updated the README to include documentation for schema validation
- Updated the README to fix invalid example code
